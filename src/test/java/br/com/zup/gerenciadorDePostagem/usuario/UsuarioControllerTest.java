...
public class UsuarioControllerTest {
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoEmailForaPadrao() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoEmailNotNull() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoSenhaNotNull() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoSenhaSizeMin() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoNomeNotBlank() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoNomeNotNull() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
    ...
    @Test
    @WithMockUser(username = EMAIL_USUARIO, password = SENHA)
    public void testarRotaParaAtualizarUsuarioValidacaoNomeSizeMin() throws Exception {
        when(conversorAutenticacao.converterAutenticacao(any(Authentication.class))).thenReturn(usuario);
        when(modelMapper.map(any(UsuarioDto.class), any())).thenReturn(usuario);
        when(usuarioService.atualizarUsuario(anyString(), any(Usuario.class))).thenReturn(usuario);
